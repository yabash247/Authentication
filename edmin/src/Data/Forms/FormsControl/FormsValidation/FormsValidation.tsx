...
import { FormValidationProp, TooltipValidationProp } from "../../../../Type/Forms/FormControls/FormValidation/FormValidation";
...
export const tooltipFormSubTitle =[ {
  ...
  {
    text: "-tooltip classes to display validation feedback in a styled tooltip.",
  },
]
