...
import { AddRowsTable, DeleteRowData, DeleteRowDataProp } from "../../../../Type/Tables/DataTables/ApiDataTable";
import { TableActionTypes, ZeroConfigurationTableColumnsType } from "../../../../Type/Tables/DataTables/BasicInit";
  ...
  export const filteringTableData = [
    {
      name: (
        <>
          <Image className="img-fluid table-avtar" src={dynamicImage(`avatar/7.jpg`)} alt="user image" />
          Airi Satou
        </>
      ),
      position: "Accountant",
    ...
    },
    {
      name: (
        <>
          <Image className="img-fluid table-avtar" src={dynamicImage(`avatar/11.jpg`)} alt="user image" />
          Ashton Cox
        </>
      ),
    ...
    },
    {
      name: (
        <>
          <Image className="img-fluid table-avtar" src={dynamicImage(`avatar/3.jpg`)} alt="user image" />
          Cedric Kelly
        </>
      ),
