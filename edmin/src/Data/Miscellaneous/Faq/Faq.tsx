import {  FaBookReader, FaCheck, FaDollarSign, FaEnvelope, FaFileAlt, FaGlobe, FaLink, FaPenSquare, FaRedoAlt, FaSms, FaYoutube } from "react-icons/fa";
...
export const articleData = [
    ...
    },
    {
      id: 2,
      title: "Knowledgebase",
      paragraph: "A Website Designing course enables learners to use essential designing and programming tools required to do the job. The curriculum is a blend of various themes.parturient montes, nascetur ridiculus mus.",
      icon: "book-open",
      sm: "6",
      box: "6",
    },
  ...
  export const latestFaqData = [
    {
      iconClass: <FaRedoAlt className="font-primary"/>,
      val: "DavidLinner",
      title: "requested money back for a double debit card charge",
      time: "10 minutes ago",
    },
    {
      iconClass: <FaDollarSign className="font-primary" />,
      title: "All sellers have received monthly payouts",
      time: "2 hours ago",
    },
    {
      iconClass: <FaLink className="font-primary"/>,
    ...
    {
      iconClass:<FaCheck className="font-primary"/>,
      val: "Victoria Wilson",
