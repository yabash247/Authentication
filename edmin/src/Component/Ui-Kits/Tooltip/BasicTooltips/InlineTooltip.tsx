...
import { Btn, H4, P, ToolTip } from '../../../../AbstractElements';
  ...
  return (
    <div>
      ...
      <P>
        ...
        <Link id="Tooltip-2" className="font-primary fw-bold ms-1 me-1" to={Href}>{TooltipSmall}</Link>
        inside the content with help of tooltip and also you can add
        <Btn id="Tooltip-2" color="secondary" className="text-white border-0 px-3 py-1 me-1 ms-1 mb-0">{ButtonSmall}</Btn>.  Tooltips helps you to add more and more content. A tooltip is often used to specify extra information about something when the user moves the mouse pointer over an element
      </P>
