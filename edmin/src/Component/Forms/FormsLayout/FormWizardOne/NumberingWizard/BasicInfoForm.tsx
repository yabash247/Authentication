...
import { AgreeToTermsAndConditions, ConfirmPassword, Email, EnterConfirmPassword, EnterPassword, EnterYourName, FirstName, EdminMail, Password } from '../../../../../utils/Constant';
