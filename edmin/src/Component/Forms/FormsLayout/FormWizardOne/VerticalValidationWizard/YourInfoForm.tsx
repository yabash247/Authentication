...
import { AgreeToTermsAndConditions, ContactNumber, Email, EnterFirstName, EnterLastName, EnterNumber, FirstName, LastName, EdminMail, Next, State, ZipCode } from '../../../../../utils/Constant';
