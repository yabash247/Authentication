...
import { AgreeToTermsAndConditions, ContactNumber, Continue, Email, EnterFirstName, EnterLastName, EnterNumber, FirstName, LastName, EdminMail, State, ZipCode } from '../../../../../utils/Constant';
  ...
  return (
    <Form onSubmit={(event) => event.preventDefault()} className="needs-validation" noValidate>
      <Row className='g-3'>
        ...
        <Col xl="4" xs="12" className='form theme-form'>
