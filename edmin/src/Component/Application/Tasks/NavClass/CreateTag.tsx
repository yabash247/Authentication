...
import { CreatePropsTypes } from '../../../../Type/Application/Tasks/Tasks'
  ...
  return (
    <Modal className="modal-bookmark" isOpen={tagModal} toggle={tagToggle} size="lg">
      <div className='modal-header'>
        <H5 className='modal-title'>{CreateTagHeading}</H5>
        <Btn close color='transparent' onClick={tagToggle} ></Btn>
      </div>
      <ModalBody>
          ...
          <Row>
            ...
            <Col md="12" className='mt-0'>
              <FormGroup>
                ...
                <input className="form-color d-block" type="color" {...register('color', { required: true })} defaultValue="#43B9B2" />
              </FormGroup>
            </Col>
          </Row>
