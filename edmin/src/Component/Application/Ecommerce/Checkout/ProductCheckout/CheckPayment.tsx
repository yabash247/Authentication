      ...
      <Row>
        <Col>
          <Label className="d-block" for="edo-ani">
            <Input className="radio-primary" id="edo-ani" type="radio" name="rdo-ani" defaultChecked />{CheckPayments}
          </Label>
          <Label className="d-block" for="edo-ani1">
            <Input className="radio-primary" id="edo-ani1" type="radio" name="rdo-ani"/>
            {CashOnDelivery}
          </Label>
          <Label className="d-flex align-items-center" for="edo-ani2">
            <Input className="radio-primary" id="edo-ani2" type="radio" name="rdo-ani" defaultChecked/>
            {Paypal}
