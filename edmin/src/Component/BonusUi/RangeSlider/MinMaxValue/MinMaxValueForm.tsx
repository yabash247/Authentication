            ...
            <Col md="10">
                <div style={{ color: "#FD7E40" }} className="d-flex justify-content-center flex-wrap m-3">
                    ...
                    renderThumb={({ props ,index}) => (
                        <div {...props} key={index} className="d-flex justify-content-center align-items-center rounded-5" style={{ ...props.style, height: "25px", width: "25px", border: "3px solid #FD7E40", backgroundColor: "#FFF", boxShadow: "0px 2px 6px #AAA" }}>
