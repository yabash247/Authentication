            ...
            <Col md="10">
                <div className="d-flex justify-content-center flex-wrap m-3">
                    ...
                    renderThumb={({ props, isDragged ,index}) => (
                        <div {...props} key={index} className="d-flex justify-content-center align-items-center rounded-5" style={{ ...props.style, height: "35px", width: "35px", backgroundColor: "#FFF",border: "3px solid #C42A02", boxShadow: "0px 2px 6px #AAA" }}>
