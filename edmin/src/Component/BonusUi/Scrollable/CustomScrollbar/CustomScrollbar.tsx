      ...
      <Card>
        ...
        <CardBody>
          <ScrollBar style={{ width: "100%", height: "300px" }} className="scroll-demo">
            ...
            <P>I'm quite interested in learning more about <em className="font-danger">custom scrollbars</em> because they are becoming more and more common.</P>
            ...
            <P>One crucial point to remember is that, depending on the design, a scrollbar may operate either <em className="font-danger">horizontally or vertically</em> . Additionally, it might alter when you work on a website that is global and operates in both left-to-right and right-to-left orientations.</P>
          </ScrollBar>
        </CardBody>
      </Card>
    </Col>
