    ...
    <Gallery withCaption>
      {galleryGridImages.map((item, index) => (
        <figure key={index} className="col-xl-3 col-sm-6" itemProp="caption description">
          <Item original={dynamicImage(item)}  caption="is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy." width="226" height="339">
            {({ ref, open }) => (
              <Link to={Href} onClick={open}>
                <img ref={ref} src={dynamicImage(item)} alt="thumbnail" />
